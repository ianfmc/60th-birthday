  ...
  destinations: [
    ...
    },
    {
      ...
      properties: [
        ...
        { name: "Koloa Landing Resort at Poipu, Autograph Collection", role: "Kauaʻi hotel candidate", inventory: "canonical Marriott inventory", source: "https://www.marriott.com/en-us/hotels/lihak-koloa-landing-resort-at-poipu-autograph-collection/overview/", confidence: "needs verification" as Confidence, vegan: "requires planning" as VeganSupport, note: "Koloa Landing is on Kauaʻi and is served by LIH, not KOA. If selected alongside the fixed LAX–KOA itinerary, include the separate KOA–LIH island hop. Verify a king room with a view, a refundable October rate, all taxes and resort fees, Marriott Titanium benefits, and plant-based dining arrangements." },
      ...
      flight: { origin: "LAX", destination: "KOA", cabin: "First class or premium economy; nonstop preferred", estimate: 1150, confidence: "estimated" as Confidence },
