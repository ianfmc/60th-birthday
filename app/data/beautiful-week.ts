  ...
  destinations: [
    {
      ...
      properties: [
        ...
        { name: "Cabo Surf Hotel", role: "San José del Cabo candidate", inventory: "canonical hotel inventory", source: "https://www.cabosurfhotel.com/rooms", confidence: "needs verification" as Confidence, vegan: "requires planning" as VeganSupport, note: "Oceanfront king rooms with kitchenettes fit the brief. Verify October availability, refundable terms, full taxes and fees, and plant-based dining arrangements." },
      ],
