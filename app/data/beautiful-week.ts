...
export const extraordinary = {
  ...
  properties: [
    ...
    { destination: "Kauaʻi", name: "Koloa Landing Resort at Poipu, Autograph Collection", dates: "2026-10-20/2026-10-27", lodging: 8528, airfare: 900, transport: 250, meals: 1050, experiences: 450, contingency: 300, total: 11478, confidence: "needs verification" as Confidence, inventory: "one-bedroom king villa with view and balcony preferred; full-week inventory currently unavailable", dining: "adequate vegan support" as VeganSupport, source: "https://www.marriott.com/en-us/hotels/lihak-koloa-landing-resort-at-poipu-autograph-collection/overview/", note: "Fallback only if Hāpuna is dropped. Monitor specifically for the one-bedroom villa with a king, view and balcony; do not substitute the oversized two-bedroom villa. Reprice flights to Līhuʻe and reconfirm the complete total and cancellation deadline before booking.", monitoring: { checkedAt: "2026-08-28T16:00:00-07:00", previousTotal: null, deltaPercent: null, alert: false, summary: "The preferred one-bedroom king villa appeared for a short two-night stay but not for the complete seven-night week. Continue monitoring exact-week inventory." } },
  ],
} as const;
