...
export const extraordinary = {
  ...
  properties: [
    ...
    { destination: "Kauaʻi", name: "Koloa Landing Resort at Poipu, Autograph Collection", dates: "2026-10-20/2026-10-27", lodging: 8528, airfare: 900, transport: 250, meals: 1050, experiences: 450, contingency: 300, total: 11478, confidence: "confirmed/current" as Confidence, inventory: "canonical resort inventory", dining: "adequate vegan support" as VeganSupport, source: "https://www.marriott.com/en-us/hotels/lihak-koloa-landing-resort-at-poipu-autograph-collection/overview/", note: "Fallback only if Hāpuna is dropped. Reprice flights to Līhuʻe and reconfirm the room category, full total and cancellation deadline before booking.", monitoring: { checkedAt: "2026-08-27T17:30:00-07:00", previousTotal: null, deltaPercent: null, alert: false, summary: "Koloa Landing is the single fallback and remains within the $12,000 trip ceiling using the current conservative assumptions." } },
  ],
} as const;
