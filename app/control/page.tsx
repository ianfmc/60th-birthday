...
export default function ControlPlane() {
  return <main className="control-shell">
    ...
    <div className="page-freshness"><span>Latest monitoring check</span><strong>{flightMonitor.checkedAt ? new Date(flightMonitor.checkedAt).toLocaleString("en-US", { timeZone: "America/Los_Angeles", month: "long", day: "numeric", year: "numeric", hour: "numeric", minute: "2-digit", timeZoneName: "short" }) : "Awaiting first live check"}</strong><small>Live airfare updated · daily checks scheduled for 6:00 AM Pacific</small></div>
