...
const lodgingIdByPropertyName:Record<string,string>={"Casa Suhana":"casa-suhana","Casa Rayrae":"casa-rayrae","Hale Naiʻa":"hale-naia","La Puesta Sayulita":"la-puesta-sayulita","Montecristo Estates":"montecristo","Hotel El Ganzo":"el-ganzo","Solaz, a Luxury Collection Resort, Los Cabos":"solaz","Casa Velas":"casa-velas","Rivera del Rio Boutique Hotel":"rivera-del-rio","Garza Blanca Preserve Resort & Spa":"garza-blanca","Waikoloa Beach Villas":"waikoloa-villas","Koloa Landing Resort at Poipu, Autograph Collection":"koloa-landing","The Westin Hāpuna Beach Resort":"westin-hapuna","Manava Moʻorea · Overwater Bungalow":"manava-moorea"};
const extraordinaryFlightIds:Record<string,string> = { "Casa Suhana":"puerto-vallarta", "Casa Rayrae":"original-cabo", "Hale Naiʻa":"big-island", "The Lagoon House":"tahiti", "Manava Moʻorea · Overwater Bungalow":"tahiti", "The Westin Hāpuna Beach Resort":"big-island", "Koloa Landing Resort at Poipu, Autograph Collection":"kauai" };
