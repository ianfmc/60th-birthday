...
const stays = [
  { id: "casa-suhana", collectionId: "extraordinary", destinationId: "extraordinary-1", name: "Casa Suhana", query: "Casa Suhana Puerto Vallarta", checkIn: "2026-10-22", checkOut: "2026-10-29" },
  { id: "casa-rayrae", collectionId: "extraordinary", destinationId: "extraordinary-2", name: "Casa Rayrae", query: "Casa Rayrae Los Cabos", checkIn: "2026-10-15", checkOut: "2026-10-22" },
  ...
  { id: "westin-hapuna", collectionId: "extraordinary", destinationId: "extraordinary-4", name: "The Westin Hāpuna Beach Resort", query: "Westin Hapuna Beach Resort", checkIn: "2026-10-20", checkOut: "2026-10-27", roomPattern: /(king.*(ocean|view|balcony)|(ocean|view|balcony).*king)/i },
  { id: "koloa-landing", collectionId: "extraordinary", destinationId: "extraordinary-5", name: "Koloa Landing Resort at Poipu, Autograph Collection", query: "Koloa Landing Resort Poipu", checkIn: "2026-10-21", checkOut: "2026-10-28", roomPattern: /((1|one)[ -]?bedroom.*king.*(island|ocean|view|balcony)|(island|ocean|view|balcony).*(1|one)[ -]?bedroom.*king)/i },
  { id: "montecristo", collectionId: "beautiful-week", destinationId: "cabo", name: "Montecristo Estates", query: "Montecristo Estates Los Cabos", checkIn: "2026-10-15", checkOut: "2026-10-22", roomPattern: /((3|three) bedrooms?.*(ocean|view)|(ocean|view).*(3|three) bedrooms?)/i },
  { id: "el-ganzo", collectionId: "beautiful-week", destinationId: "cabo", name: "Hotel El Ganzo", query: "Hotel El Ganzo Los Cabos", checkIn: "2026-10-15", checkOut: "2026-10-22", roomPattern: /(king.*(ocean|view)|(ocean|view).*king)/i },
  { id: "solaz", collectionId: "beautiful-week", destinationId: "cabo", name: "Solaz, a Luxury Collection Resort, Los Cabos", query: "Solaz Luxury Collection Resort Los Cabos", checkIn: "2026-10-15", checkOut: "2026-10-22", roomPattern: /(king.*(ocean|sea|view)|(ocean|sea|view).*king)/i },
  { id: "la-puesta-sayulita", collectionId: "beautiful-week", destinationId: "puerto-vallarta", name: "La Puesta Sayulita", query: "La Puesta Sayulita", checkIn: "2026-10-22", checkOut: "2026-10-29", roomPattern: /(king.*(ocean|water|view|sunset)|(ocean|water|view|sunset).*king)/i },
  { id: "garza-blanca", collectionId: "beautiful-week", destinationId: "puerto-vallarta", name: "Garza Blanca Preserve Resort & Spa", query: "Garza Blanca Preserve Resort Puerto Vallarta", checkIn: "2026-10-22", checkOut: "2026-10-29", roomPattern: /(king.*(ocean|water|view)|(ocean|water|view).*king)/i },
];
