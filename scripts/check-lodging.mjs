...
const stays = [
  ...
  { id: "koloa-landing", collectionId: "extraordinary", destinationId: "extraordinary-5", name: "Koloa Landing Resort at Poipu, Autograph Collection", query: "Koloa Landing Resort Poipu", checkIn: "2026-10-20", checkOut: "2026-10-27", roomPattern: /((1|one)[ -]?bedroom.*king.*(island|ocean|view|balcony)|(island|ocean|view|balcony).*(1|one)[ -]?bedroom.*king)/i },
